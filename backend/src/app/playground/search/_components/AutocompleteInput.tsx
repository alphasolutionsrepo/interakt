// app/playground/search/_components/AutocompleteInput.tsx

/**
 * Autocomplete Input Component
 *
 * A search input with autocomplete dropdown suggestions.
 * Uses the useAutocomplete hook internally.
...
} from '../_lib/hooks/useAutocomplete';
...
export interface AutocompleteInputProps
  extends Omit<UseAutocompleteOptions, 'onSelect'> {
  /** Input placeholder */
  placeholder?: string;
        ...
        >
          ...
          <ul className="max-h-80 overflow-auto py-1">
            {suggestions.map((suggestion, index) => (
              <li key={`${suggestion.text}-${suggestion.indexId}-${index}`}>
                <button
                  type="button"
