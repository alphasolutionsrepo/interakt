// app/playground/search/_lib/hooks/useAutocomplete.ts

/**
 * useAutocomplete Hook
 *
 * React hook for implementing autocomplete/type-ahead suggestions.
 * Handles debouncing, API calls, and state management.
 */
...
export interface UseAutocompleteOptions {
  ...
  debounceMs?: number;
  /** Optional: limit to specific index ID */
  indexId?: string;
...
export function useAutocomplete(options: UseAutocompleteOptions): UseAutocompleteReturn {
  ...
  const fetchSuggestions = useCallback(
    ...
    [apiUrl, accessToken, minLength, maxSuggestions, indexId, clearSuggestions]
  );
  ...
  }, [query, minLength, debounceMs, enabled, fetchSuggestions, clearSuggestions]);
