...
Integrations that keep a content platform — pages, articles, products, and taxonomy — in sync with
an Interakt **Search Index**, so site search and chat always reflect what editors have published.

- [Storyblok](./storyblok/how-to-integrate-interakt-with-storyblok) — a one-time backfill plus a
  publish webhook keep an index current, with drop-in search and chat widgets on the site.
...
> point a Search Experience and an AI Experience at the result.
